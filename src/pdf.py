# -*- coding: utf-8 -*-
"""
Conversão de .docx para .pdf via automação COM do Microsoft Word instalado
na máquina (mesmo motor usado em "Salvar como PDF" no Word) — é a única
forma confiável de preservar 100% o layout do modelo offline.

Mantém uma única instância do Word aberta durante todo um lote
(`ConversorPDF` usado como context manager), em vez de abrir/fechar o Word
a cada página gerada.
"""
